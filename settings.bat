...
:: Dark mode
if "!choice!"=="8" goto darkmodechange
if "!choice!"=="?8" (
	echo By default, dark mode is on.
	echo:
	echo It's used to help prevent eye strain while also giving
	echo off a nice, "premium" look. Note that dark mode will
	echo not apply in the video maker and it will be more like
	echo a gray mode when you're in the character creator and
	echo character browser.
	echo:
	echo Turning this off will make Offline switch to
